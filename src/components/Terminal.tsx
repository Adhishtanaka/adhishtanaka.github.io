...
export default function Terminal({ user }: { user: GHUser | null }) {
  return (
    <section className="my-20 border-3 border-white bg-navy-dark overflow-hidden">
      <div className="bg-white text-navy-dark px-4 py-2 flex justify-between items-center font-bold text-sm">
      ...
      <div className="p-6 md:p-8 text-sm md:text-base leading-relaxed font-mono">
        <div className="text-accent mb-2 cmd cursor-pointer hover:opacity-80 transition-opacity">
          <span className="text-accent-light mr-4">$</span>whoami --verbose
        </div>
        ...
        <div className="text-accent mb-2 cmd cursor-pointer hover:opacity-80 transition-opacity">
          <span className="text-accent-light mr-4">$</span>cat /etc/stack.conf
        </div>
        ...
        <div className="text-accent mb-2 cmd cursor-pointer hover:opacity-80 transition-opacity">
          <span className="text-accent-light mr-4">$</span>ping github.com/{user?.login || "Adhishtanaka"} -c 1
        </div>
        <div className="text-fg mb-6 pl-8 opacity-80">
        ...
        <div className="flex items-center gap-4 mt-8">
          ...
          <span className="text-accent">_awaiting_input</span>
          <div className="w-3 h-5 bg-accent animate-pulse"></div>
        </div>
      </div>
    </section>
  );
